...
func turn_of_buttons():
	$Inventory/Panel/VBoxContainer/Tool1.set_pressed(false)
	$Inventory/Panel/VBoxContainer/Tool2.set_pressed(false)
	$Inventory/Panel/VBoxContainer/Tool3.set_pressed(false)
	$Inventory/Panel/VBoxContainer/Tool4.set_pressed(false)
	$Inventory/Panel/VBoxContainer/Tool5.set_pressed(false)
	$Inventory/Panel/VBoxContainer/Tool6.set_pressed(false)


func _on_Tool1_pressed():
	turn_of_buttons()
	$Inventory/Panel/VBoxContainer/Tool1.set_pressed(true)
	emit_signal("tool_button_pressed", lib.TOOLS.tool1)

func _on_Tool2_pressed():
	turn_of_buttons()
	$Inventory/Panel/VBoxContainer/Tool2.set_pressed(true)
	emit_signal("tool_button_pressed", lib.TOOLS.tool2)

func _on_Tool3_pressed():
	turn_of_buttons()
	$Inventory/Panel/VBoxContainer/Tool3.set_pressed(true)
	emit_signal("tool_button_pressed", lib.TOOLS.tool3)

func _on_Tool4_pressed():
	turn_of_buttons()
	$Inventory/Panel/VBoxContainer/Tool4.set_pressed(true)
	emit_signal("tool_button_pressed", lib.TOOLS.tool4)

func _on_Tool5_pressed():
	turn_of_buttons()
	$Inventory/Panel/VBoxContainer/Tool5.set_pressed(true)
	emit_signal("tool_button_pressed", lib.TOOLS.tool5)


func _on_Tool6_pressed():
	turn_of_buttons()
	$Inventory/Panel/VBoxContainer/Tool6.set_pressed(true)
